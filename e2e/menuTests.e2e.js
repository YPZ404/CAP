describe('Example', () => {
    ...
    it('should be taken to home page when pressing home page in menu', async () => {
      await expect(element(by.text('Home Page'))).tap();
      await expect(element(by.text('Concussion'))).toBeVisible();
    ...
    it('should be taken to login page from menu item', async () => {
      await expect(element(by.text('Login'))).tap();
    ...
    it('should be taken to reports page from menu item', async () => {
      await expect(element(by.text('Reports'))).tap();
    ...
    it('should be taken to DSC from menu item', async () => {
      await expect(element(by.text('Daily Symptom Checklist'))).tap();
      await expect(element(by.text('Does the affected person have any of these \
                                    symptoms?'))).toBeVisible();
